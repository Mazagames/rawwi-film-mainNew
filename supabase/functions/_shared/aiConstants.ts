...
قاعدة الأشكال: إذا وُجد بعد لفظ «أشكال: …» فكل الأشكال المذكورة هناك تُعامل مثل ذلك اللفظ لنفس المادة.
...
7. إذا ظهر «أشكال: أ، ب، ج» بعد لفظ في القائمة، فكل من أ وب وج ألفاظ محظورة بنفس المادة والشدة عند ظهور أي منها في النص

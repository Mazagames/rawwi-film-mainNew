...
async function runTest() {
  ...
  const oldMdPath = path.join(__dirname, "test_art12_old.md");
  const newMdPath = "C:/Users/wahid/.gemini/antigravity-ide/brain/14e69c26-66f0-46be-8541-6f399376b446/scratch/article_12_new.md";
  ...
  const eventText = `
المقطع يبدأ:
رجل عصابة يقول للطفل (10 سنوات): "إذا لم تذهب وتسرق هذه المحفظة الآن، سأضربك حتى الموت."
الطفل يبكي ويقول: "أرجوك لا."
المقطع ينتهي.
  `;

...
export const config = {
  ...
  CHUNK_SOFT_TIMEOUT_MS: Math.max(
    60_000,
    parseInt(process.env.CHUNK_SOFT_TIMEOUT_MS ?? "240000", 10) || 240_000
  ),
  ...
  SCRIPT_SUMMARY_CACHE_MAX_ENTRIES: Math.max(1, parseInt(process.env.SCRIPT_SUMMARY_CACHE_MAX_ENTRIES ?? "256", 10) || 256),
  SCRIPT_SUMMARY_CACHE_TTL_MS: Math.max(0, parseInt(process.env.SCRIPT_SUMMARY_CACHE_TTL_MS ?? "1800000", 10) || 1800000),
  SCRIPT_SUMMARY_LOCK_WAIT_MS: Math.max(1000, parseInt(process.env.SCRIPT_SUMMARY_LOCK_WAIT_MS ?? "90000", 10) || 90000),

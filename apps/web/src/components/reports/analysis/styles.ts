...
export const analysisStyles = StyleSheet.create({
  ...
  sectionHeading: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderBottomWidth: 1, marginBottom: 10 },
  sectionCount: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 7, paddingVertical: 2, fontSize: 9, fontWeight: "bold" },
  statisticsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginTop: 18 },
  summaryBlock: { marginTop: 24, borderTopWidth: 1, borderTopColor: "#E5E7EB", paddingTop: 12 },
  ...
  cardHeading: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 8, marginBottom: 3 },
  cardClassification: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 1, fontSize: 7 },
  emptySection: { fontSize: 10, color: "#6B7280", marginTop: 16 },
